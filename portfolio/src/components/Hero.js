      ...
      <div className="hero-inner">
        <div className="hero-text">
          ...
          <p className="hero-sub-right-fixed">
             ...
             <p className="hero-sub-right2"> <span>I handle the development, deployment</span> <br /> <span>and maintenance of your Website and App's Backend, start to finish.</span> </p>
            </span>
